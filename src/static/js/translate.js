...
(function() {
    ...
    const translations = {
        ...
        'One of the world oldest urban civilizations that mysteriously declined': '世界上最早的城市文明之一，神秘衰落',
        'Imperial Russian treasures that vanished during the revolution': '革命期间消失的俄罗斯帝国珍宝',
        'An ancient Egyptian city that sank into the Mediterranean Sea': '一座沉入地中水的古埃及城市',
        ...
        'Discover fascinating mysteries, forgotten histories, and lesser-known stories from around the world.': '探索世界各地的谜团、被遗忘的历史和鲜为人知的故事。',
        'All rights reserved.': '版权所有。',
        'About Mystery History': '关于神秘历史',
        'Welcome to Mystery History, your gateway to the world most fascinating unsolved mysteries and forgotten tales from the past.': '欢迎来到神秘历史，这里是通往世界上最迷人的未解之谜和被遗忘故事的门户。',
        'Our Mission': '我们的使命',
        'We are dedicated to bringing you well-researched, engaging stories about historical mysteries that continue to captivate and puzzle us. From ancient civilizations that vanished without a trace to unexplained phenomena that defy scientific explanation, we explore the questions that have intrigued humanity for centuries.': '我们致力于为您提供经过深入研究、引人入胜的历史谜团故事。从无影无踪消失的古代文明到科学无法解释的超自然现象，我们探索那些几个世纪以来一直吸引人类的问题。',
        'What We Cover': '我们的内容',
        'Ancient Mysteries: Explore enigmatic artifacts, lost civilizations, and archaeological puzzles.': '古代之谜：探索神秘文物、失落文明和考古谜题。',
